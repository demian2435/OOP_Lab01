...
public class TestUniversity {
	...
	public void testNameRector() {
		...
		assertNotNull("Missing university name", name);
	...
	public void testEnroll() {
		...
		assertEquals("Wrong id number for first enrolled student", 10007, s1);
		assertEquals("Wrong id number for second enrolled student", 10008, s2);
	}
...
//		assertContained("Wrong description of course", "James", poli.course(oop));
	...
	private static void assertContained(String msg, String expectedSubStr, String actualStr) {
		assertTrue((msg == null ? "" : msg + ": ") + "expected sub string [" + expectedSubStr
				+ "] is not contained in [" + actualStr + "]",
